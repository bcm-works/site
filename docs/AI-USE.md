...
Use of AI Code Generation tools in this repository must follow each of these rules:

1. Technical and architectural design must be done by a human
2. AI can then be used to build out based on the human's design
